from pyclassify.utils import distance, majority_vote, distance_numpy
...
class kNN:
    def __init__(self, k: int, backhand = "plain"):
        ...
        #Check 'backhand':
        if(backhand != "plain" and backhand != "numpy"):
            raise ValueError("backhand must be either 'plain' or 'numpy'")
